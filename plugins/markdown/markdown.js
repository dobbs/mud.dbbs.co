 ...
 */
var _bind, dataLine, emit, expand, marked, markedOptions, renderer, toggle;

marked = require('md');
dataLine = 0;
renderer = new marked.Renderer(); // wiki headings are always h3
...
},{"md":2}],2:[function(require,module,exports){
'use strict';
    ...
    case 'table':
      {
        ...
        for (i = 0; i < this.token.header.length; i++) {
          cell += this$1.renderer.tablecell(this$1.inline.output(this$1.token.header[i]), { header: true, align: this$1.token.align[i] });
        }
...
},{"slugo":3}],3:[function(require,module,exports){
